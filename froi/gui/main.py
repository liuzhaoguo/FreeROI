...
import  base.bpdataset as globalvariable
...
class BpMainWindow(QMainWindow):
    ...
    def _init_data_select(self):
        ...
        if globalvariable.threeD_fourD_flag:
            self.list_view.volume_index_spinbox.setEnabled(True)
            self.list_view.volume_index_spinbox.setRange(0,globalvariable.data.shape[3]-1)
    ...
    def _volume_index_changed(self):
        ...
        new_vol = globalvariable.data[:,:,:,self.list_view.volume_index_spinbox.value()]
